import darkSaasLandingPage from "@/assets/images/ai-sdn.png";
import lightSaasLandingPage from "@/assets/images/med.png";
import aiStartupLandingPage from "@/assets/images/Migration.png";
        ...
        <div className="mt-10 md:mt-20 flex flex-col gap-20">
          {portfolioProjects.map((project, projectIndex) => (
            ...
            style={{
              ...
              className=" rounded-xl mt-8 -mb-4 md:-mb-0 lg:mt-5 lg:size-70"/>
              </div>
              </div>
            </Card>
          ))}
